...
function EntryItem({padZero, entry, handleDeleteEntry, handleEditEntry}) {
  ...
  const saveDuration = (value) => {
    ...
    console.log(value);
    // console.log('heeeeeeeeeeeereee');
    
    // console.log(seconds, minutes, hours);
    // const newEndTime = moment(startTime).add(seconds + (60*minutes) + (60*60*hours), 'seconds')._d
        ...
        <div className='duration d-flex align-items-center'>
          {isEditDuration ? 
            <>
              ...
              {/* <TimeInput entry={entry} onChange={changeDuration} saveDuration={saveDuration} onCancel={() => {setIsEditDuration(false)}}/> */}
              {/* <DateTimePicker
